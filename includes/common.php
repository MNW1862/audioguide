...
// Generate nonce string to secure CSP
$nonce_string = base64_encode(random_bytes(96));
...
header("Content-Security-Policy: base-uri 'self'; object-src 'none'; script-src 'unsafe-inline' 'nonce-$nonce_string'; script-src-attr 'self';");
